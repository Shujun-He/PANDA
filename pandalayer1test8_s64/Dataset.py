...
class PANDADataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self,idx):
        ...
        #tensor=0
        tensors=self._get_tensors_from_paths(image_ids).transpose((0,1,4,2,3)).copy()
        ...
        uncertainty_penalty=self.uncertainty_penalty[indices]
        return {'tensors':tensors,'labels':labels,'gleason1':gleason1,'gleason2':gleason2,"uncertainty_penalty":uncertainty_penalty}
        #return tensor
    ...
    def _get_labels(self):
        ...
        self.data_provider=np.asarray(self.df.data_provider.to_list())
        self.score1=[]
        self.score2=[]
        ...
        self.uncertainty_penalty=np.ones(self.size,dtype='float32')
        self.uncertainty_penalty[self.data_provider=="radboud"]=0.85
        #self.
